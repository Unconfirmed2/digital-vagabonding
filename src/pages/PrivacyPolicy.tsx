        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-lg shadow-sm p-0 md:p-8 bg-transparent">
            ...
            <div className="prose max-w-none text-gray-700 space-y-6">
              ...
              <p>We may use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.</p>
              ...
              <ul className="list-disc ml-6">
                ...
                <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Digital VagaBonding.</li>
                ...
                <li><b>Website</b> refers to Digital VagaBonding, accessible from <a href="https://digitalvagabond.ing" className="text-blue-600 underline">https://digitalvagabond.ing</a></li>
              ...
              <p>We may use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We may use may include:</p>
              <ul className="list-disc ml-6">
